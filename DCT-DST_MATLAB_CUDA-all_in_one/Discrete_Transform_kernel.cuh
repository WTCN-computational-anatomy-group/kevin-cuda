...
// cosine
__global__ void DCTI_Column_Kernel_GPUA(double const * const A, double * const C,
...
__global__ void DCTI_Column_Inverse_Kernel_GPUA(double const * const A, double * const C,
	int numARows, int numAColumns,
	int numCRows, int numCColumns)
{
	double CValue = 0.0;
...
__global__ void DCTI_Row_Kernel_GPUA(double const * const A, double * const C,
	int numARows, int numAColumns,
	int numCRows, int numCColumns)
{
	double CValue = 0.0;
	...
	for (int k = 0; k < (TILE_DIM + numAColumns - 1) / TILE_DIM; k++) {
		...
		if (k*TILE_DIM + threadIdx.y < numAColumns && Col < numAColumns)	{ Bs[threadIdx.y][threadIdx.x] = cos(((threadIdx.y + k*TILE_DIM)*PI_d*Col / (numAColumns - 1)))*sqrt(1.0 / (1 + DELTA(Col + 1, 1) + DELTA(Col + 1, numAColumns)))*sqrt(1.0 / (1 + DELTA(1, (threadIdx.y + k*TILE_DIM) + 1) + DELTA(numAColumns, (threadIdx.y + k*TILE_DIM) + 1)))*sqrt(2.0 / numAColumns); }
...
__global__ void DCTI_Row__InverseKernel_GPUA(double const * const A, double * const C,
	int numARows, int numAColumns,
	int numCRows, int numCColumns)
{
	double CValue = 0.0;
...
__global__ void DCTII_Row_Kernel_GPUA(double const * const A, double * const C,
	int numARows, int numAColumns,
	int numCRows, int numCColumns)
{
	double CValue = 0.0;
...
__global__ void DCTII_Row__InverseKernel_GPUA(double const * const A, double * const C,
	int numARows, int numAColumns,
	int numCRows, int numCColumns)
{
	double CValue = 0.0;
...
__global__ void DCTII_Column_Kernel_GPUA(double const * const A, double * const C,
	int numARows, int numAColumns,
	int numCRows, int numCColumns)
{
	double CValue = 0.0;
	...
	for (int k = 0; k < (TILE_DIM + numARows - 1) / TILE_DIM; k++) {
		...
		if (k*TILE_DIM + threadIdx.x < numARows && Row < numARows)	{ As[threadIdx.y][threadIdx.x] = cos(((2 * Row + 1) / (2.0 * numARows))*PI_d*(threadIdx.x + (k*TILE_DIM)))*sqrt(1.0 / (1 + DELTA((threadIdx.x + (k*TILE_DIM)) + 1, 1)))*sqrt(2.0 / numARows); }
...
__global__ void DCTII_Column_Inverse_Kernel_GPUA(double const * const A, double * const C,
	int numARows, int numAColumns,
	int numCRows, int numCColumns)
{
	double CValue = 0.0;
	...
	for (int k = 0; k < (TILE_DIM + numARows - 1) / TILE_DIM; k++) {
		...
		if (k*TILE_DIM + threadIdx.x < numARows && Row < numARows)	{ As[threadIdx.y][threadIdx.x] = cos(((2 * (threadIdx.x + (k*TILE_DIM)) + 1) / (2.0 * numARows))*PI_d*Row)*sqrt(1.0 / (1 + DELTA(1, Row + 1)))*sqrt(2.0 / numARows); }
...
__global__ void DCTIII_Column_Kernel_GPUA(double const * const A, double * const C,
	int numARows, int numAColumns,
	int numCRows, int numCColumns)
{
	double CValue = 0.0;
...
__global__ void DCTIII_Column_Inverse_Kernel_GPUA(double const * const A, double * const C,
	int numARows, int numAColumns,
	int numCRows, int numCColumns)
{
	double CValue = 0.0;
...
__global__ void DCTIII_Row_Kernel_GPUA(double const * const A, double * const C,
	int numARows, int numAColumns,
	int numCRows, int numCColumns)
{
	double CValue = 0.0;
...
__global__ void DCTIII_Row__InverseKernel_GPUA(double const * const A, double * const C,
	int numARows, int numAColumns,
	int numCRows, int numCColumns)
{
	double CValue = 0.0;
...
__global__ void DCTIV_Column_Kernel_GPUA(double const * const A, double * const C,
	int numARows, int numAColumns,
	int numCRows, int numCColumns)
{
	double CValue = 0.0;
...
__global__ void DCTIV_Column_Inverse_Kernel_GPUA(double const * const A, double * const C,
	int numARows, int numAColumns,
	int numCRows, int numCColumns)
{
	double CValue = 0.0;
...
__global__ void DCTIV_Row_Kernel_GPUA(double const * const A, double * const C,
	int numARows, int numAColumns,
	int numCRows, int numCColumns)
{
	double CValue = 0.0;
...
__global__ void DCTIV_Row__InverseKernel_GPUA(double const * const A, double * const C,
	int numARows, int numAColumns,
	int numCRows, int numCColumns)
{
	double CValue = 0.0;
...
// sine
__global__ void DSTI_Column_Kernel_GPUA(double const * const A, double * const C,
	int numARows, int numAColumns,
	int numCRows, int numCColumns)
{
	double CValue = 0.0;
	...
	for (int k = 0; k < (TILE_DIM + numARows - 1) / TILE_DIM; k++) {
		...
		if (k*TILE_DIM + threadIdx.x < numARows && Row < numARows)	{ As[threadIdx.y][threadIdx.x] = sin((((Row + 1)*PI_d*((threadIdx.x + (k*TILE_DIM)) + 1)) / (numARows + 1)))*sqrt(2.0 / (numARows + 1)); }
		//As[threadIdx.y][threadIdx.x] = A[Row*ACols + k*TILE_DIM + threadIdx.x];
		else											{ As[threadIdx.y][threadIdx.x] = 0.0; }
...
__global__ void DSTI_Column_Inverse_Kernel_GPUA(double const * const A, double * const C,
	int numARows, int numAColumns,
	int numCRows, int numCColumns)
{
	double CValue = 0.0;
...
__global__ void DSTI_Row_Kernel_GPUA(double const * const A, double * const C,
	int numARows, int numAColumns,
	int numCRows, int numCColumns)
{
	double CValue = 0.0;
...
__global__ void DSTI_Row__InverseKernel_GPUA(double const * const A, double * const C,
	int numARows, int numAColumns,
	int numCRows, int numCColumns)
{
	double CValue = 0.0;
...
__global__ void DSTII_Row_Kernel_GPUA(double const * const A, double * const C,
	int numARows, int numAColumns,
	int numCRows, int numCColumns)
{
	double CValue = 0.0;
...
__global__ void DSTII_Row__InverseKernel_GPUA(double const * const A, double * const C,
	int numARows, int numAColumns,
	int numCRows, int numCColumns)
{
	double CValue = 0.0;
...
__global__ void DSTII_Column_Kernel_GPUA(double const * const A, double * const C,
	int numARows, int numAColumns,
	int numCRows, int numCColumns)
{
	double CValue = 0.0;
...
__global__ void DSTII_Column_Inverse_Kernel_GPUA(double const * const A, double * const C,
	int numARows, int numAColumns,
	int numCRows, int numCColumns)
{
	double CValue = 0.0;
	...
	for (int k = 0; k < (TILE_DIM + numARows - 1) / TILE_DIM; k++) {
                                                                     //As[threadIdx.y][threadIdx.x] = cos(((2 * (threadIdx.x + (k*TILE_DIM)) + 1) / (2.0 * numARows))*PI_d*Row)*sqrt(1.0 / (1 + DELTA(1, Row + 1)))*sqrt(2.0 / numARows);
		if (k*TILE_DIM + threadIdx.x < numARows && Row < numARows)	{ As[threadIdx.y][threadIdx.x] = sin(((Row + 1)*PI_d*((threadIdx.x + (k*TILE_DIM)) + 0.5)) / (numARows))*sqrt(2.0 / (numARows))*sqrt(1.0 / (1 + DELTA(numARows, Row + 1))); }
...
__global__ void DSTIII_Column_Kernel_GPUA(double const * const A, double * const C,
	int numARows, int numAColumns,
	int numCRows, int numCColumns)
{
	double CValue = 0.0;
...
__global__ void DSTIII_Column_Inverse_Kernel_GPUA(double const * const A, double * const C,
	int numARows, int numAColumns,
	int numCRows, int numCColumns)
{
	double CValue = 0.0;
...
__global__ void DSTIII_Row_Kernel_GPUA(double const * const A, double * const C,
	int numARows, int numAColumns,
	int numCRows, int numCColumns)
{
	double CValue = 0.0;
...
__global__ void DSTIII_Row__InverseKernel_GPUA(double const * const A, double * const C,
	int numARows, int numAColumns,
	int numCRows, int numCColumns)
{
	double CValue = 0.0;
...
__global__ void DSTIV_Column_Kernel_GPUA(double const * const A, double * const C,
	int numARows, int numAColumns,
	int numCRows, int numCColumns)
{
	double CValue = 0.0;
	...
	for (int k = 0; k < (TILE_DIM + numARows - 1) / TILE_DIM; k++) {
		...
		if (k*TILE_DIM + threadIdx.x < numARows && Row < numARows)	{ As[threadIdx.y][threadIdx.x] = sin(((Row + 0.5)*PI_d*((threadIdx.x + (k*TILE_DIM)) + 0.5)) / (numARows))*sqrt(2.0 / (numARows)); }
...
__global__ void DSTIV_Column_Inverse_Kernel_GPUA(double const * const A, double * const C,
	int numARows, int numAColumns,
	int numCRows, int numCColumns)
{
	double CValue = 0.0;
...
__global__ void DSTIV_Row_Kernel_GPUA(double const * const A, double * const C,
	int numARows, int numAColumns,
	int numCRows, int numCColumns)
{
	double CValue = 0.0;
...
__global__ void DSTIV_Row__InverseKernel_GPUA(double const * const A, double * const C,
	int numARows, int numAColumns,
	int numCRows, int numCColumns)
{
	double CValue = 0.0;
