...
__global__ void DCTII_Row__InverseKernel(double  *A, double  *C,
	...
	int numAColumns, int numCRows, int numCColumns)
{
	...
	DCTII_Row__InverseKernel << <dimGrid, dimBlock >> >(deviceA, deviceC, numARows, numAColumns, numCRows, numCColumns);
