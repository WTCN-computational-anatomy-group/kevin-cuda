...
////////////////////////////////////////////////////////////////////////////////////  
   ...
   mxArray *  COL_SORTA = mxCreateNumericMatrix(nnzA, 1, mxINT32_CLASS, mxREAL);
	...
	//cuDoubleComplex *d_B_dense;  gpuErrchk(cudaMalloc(&d_B_dense, numBRows * numBColumns * sizeof(*d_B_dense)));
	  ...
	  size_t pivot_dimensionsvalueD[2] = {numBRows, numBColumns};
      mxGPUArray *OUTM = mxGPUCreateGPUArray(2, (mwSize*) pivot_dimensionsvalueD, mxDOUBLE_CLASS, mxCOMPLEX, MX_GPU_DO_NOT_INITIALIZE);
      cuDoubleComplex  *d_B_dense = (cuDoubleComplex *)mxGPUGetData(OUTM);
