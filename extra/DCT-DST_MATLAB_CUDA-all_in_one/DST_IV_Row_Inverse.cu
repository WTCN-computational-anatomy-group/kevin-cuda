...
__global__ void DSTIV_Row__InverseKernel(double  *A, double  *C,
	...
	int numAColumns, int numCRows, int numCColumns)
{
	...
	DSTIV_Row__InverseKernel << <dimGrid, dimBlock >> >(deviceA, deviceC, numARows, numAColumns, numCRows, numCColumns);
